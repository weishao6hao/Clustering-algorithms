...
----
- ENN_Demo1.m: This is the main file for the demo. 

- ENN.m: This is the m function that implements our ENN method for classification. Given the training data and test data, it outputs the predicted class label of test data.  
